...
func (_m *ProductRepo) CheckByID(productID int64) (bool, *errs.AppError) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CheckByID")
	}
...
func (_m *ProductRepo) CheckByIDAndSKU(productID int64, sku string) (bool, *errs.AppError) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CheckByIDAndSKU")
	}

	var r0 bool
	var r1 *errs.AppError
	if rf, ok := ret.Get(0).(func(int64, string) (bool, *errs.AppError)); ok {
		return rf(productID, sku)
	}
...
func (_m *ProductRepo) CheckBySKU(sku string) (bool, *errs.AppError) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CheckBySKU")
	}
...
func (_m *ProductRepo) GetAll(criteria *domain.ProductListCriteria) ([]domain.ProductList, *errs.AppError) {
	...
	var r1 *errs.AppError
	if rf, ok := ret.Get(0).(func(*domain.ProductListCriteria) ([]domain.ProductList, *errs.AppError)); ok {
		return rf(criteria)
	}
...
func (_m *ProductRepo) GetAllPaginate(criteria *domain.ProductListCriteria) ([]domain.ProductList, int64, *errs.AppError) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetAllPaginate")
	}

	var r0 []domain.ProductList
	var r1 int64
	var r2 *errs.AppError
	if rf, ok := ret.Get(0).(func(*domain.ProductListCriteria) ([]domain.ProductList, int64, *errs.AppError)); ok {
		return rf(criteria)
	}
	if rf, ok := ret.Get(0).(func(*domain.ProductListCriteria) []domain.ProductList); ok {
		r0 = rf(criteria)
...
func (_m *ProductRepo) Insert(data *domain.Product) (*domain.Product, *errs.AppError) {
	...
	var r1 *errs.AppError
	if rf, ok := ret.Get(0).(func(*domain.Product) (*domain.Product, *errs.AppError)); ok {
		return rf(data)
	}
