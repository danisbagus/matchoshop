...
func (_m *IProductService) Create(data *dto.CreateProductRequest) (*dto.ResponseData, *errs.AppError) {
	ret := _m.Called(data)
...
func (_m *IProductService) Delete(productID int64) (*dto.ResponseData, *errs.AppError) {
...
func (_m *IProductService) GetDetail(productID int64) (*dto.ResponseData, *errs.AppError) {
	ret := _m.Called(productID)
...
func (_m *IProductService) GetList() (*dto.ResponseData, *errs.AppError) {
	ret := _m.Called()
...
func (_m *IProductService) Update(productID int64, data *dto.CreateProductRequest) (*dto.ResponseData, *errs.AppError) {
