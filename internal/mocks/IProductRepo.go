...
func (_m *IProductRepo) CheckByID(productID int64) (bool, *errs.AppError) {
...
func (_m *IProductRepo) CheckByIDAndSKU(productID int64, sku string) (bool, *errs.AppError) {
...
func (_m *IProductRepo) CheckBySKU(sku string) (bool, *errs.AppError) {
	ret := _m.Called(sku)
...
func (_m *IProductRepo) Delete(productID int64) *errs.AppError {
	ret := _m.Called(productID)
...
func (_m *IProductRepo) GetAll() ([]domain.ProductList, *errs.AppError) {
	ret := _m.Called()
...
func (_m *IProductRepo) GetOneByID(productID int64) (*domain.ProductDetail, *errs.AppError) {
	ret := _m.Called(productID)
...
func (_m *IProductRepo) Insert(data *domain.Product) (*domain.Product, *errs.AppError) {
	ret := _m.Called(data)
...
func (_m *IProductRepo) Update(productID int64, data *domain.Product) *errs.AppError {
